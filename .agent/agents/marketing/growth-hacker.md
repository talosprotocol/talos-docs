...
## Submodule Context
**Current State**: Repository documentation, specifications, and architecture notes. May include locked specs and operational runbooks.

**Expected State**: Accurate, structured, and kept in sync with contracts and implementation. Clear upgrade paths and strong separation of normative versus descriptive text.

**Behavior**: Houses docs that explain system architecture, behavior, invariants, and operational guidance.
